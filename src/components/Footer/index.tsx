...
const Footer = () => {
  ...
  return (
    <footer className="w-100 z-30 bg-blue-100 shadow dark:bg-blue-100 lg:mt-[5%]">
      <div className="mx-auto px-4 py-20 sm:px-10 lg:px-10 mxl:px-10 mmxl:px-12 mmmxl:px-10 xl:px-24">
        <div className="flex flex-col lg:flex-row">
          <div className="w-full lg:w-1/6">
            <div>
              <Link href="/">
                <img
                  className="h-16 md:h-12 mxl:-mt-2 mxxl:-mt-0"
                  src={`${router.basePath}/assets/logo/logo.webp`}
                  alt=""
                />
              </Link>
              <div className="mt-3 mxl:mt-7 mmmxl:mt-6">
                <Link
                  href="/about-us"
          ...
          <div className="w-full lg:w-2/5">
            ...
            <div className="flex flex-col lg:flex-row">
              ...
              <div className="text-md w-full lg:w-1/2 mxl:pr-10 mmxl:pr-0">
                <div className="mb-5">
                  <Link
      ...
      <div className="block bg-lightblue-100 py-3 text-center xxxs:text-xs text-sm font-normal dark:text-black xs:text-center sm:text-center">
