...
const CardFeature = ({description, title, icon, color} : CardFeatureProps) =>  {
  ...
  return (
        <div className={`rounded-3xl px-6 pb-16 pt-8 mxl:px-4 mxl:h-[25rem] xl:h-[calc(100%_-_1rem)] 2xl:h-[100%] ` + colorBg[color]}
        >
          {icon}
          ...
          <p className="text-left text-[18px] leading-7 4xl:leading-10 ssm:text-[1.3rem] mt-5 mxl:text-[1rem] mxl:leading-6 mmxl:leading-normal mmxl:text-[0.85rem] xl:text-[1.1rem] md:text-[1.4rem]">
          {description}
          </p>
      </div> 
)};
