...
const Journey = () => {
  ...
  return (
    <div id="journey">
      <div
        className="mx-auto flex flex-col px-8 pt-12 pb-16 sm:px-8 md:px-16 lg:mt-[2%] lg:mb-[8%] lg:flex-row lg:px-10 lg:pb-20 mxl:flex-row
     mxl:px-12
     mmxl:mb-[5%]
     mmxl:-mt-[1%]
     mmxl:flex-row
    ...
    "
      >
        ...
        <div className="mb-3 flex flex-col text-center md:mb-12 lg:mb-0 lg:w-1/2 lg:grow lg:items-start lg:text-left mxl:w-[40%]">
          <h2 className="my-5 text-left text-4xl font-normal text-darkblue-100 ssm:text-5xl md:text-5xl lg:text-3xl xl:text-4xl mxl:text-3xl mmxl:text-4xl">
            <span className="font-bold text-darkblue-100">Journey</span> Mereka{' '}
            <br /> Bersama Kami!
          </h2>
          <hr className="m-2 h-px w-1/6 border-2 border-darkblue-100 bg-darkblue-100 dark:bg-darkblue-100 md:my-10 md:mx-4 lg:my-4 mxl:my-4 mxl:mx-2" />
          <p
        ...
        <div className="w-full justify-center pr-0 text-center lg:w-3/6 mxl:w-[60%] mmxl:mt-8 xl:mt-0">
          <Slider {...settings}>
            <div className="px-4 border-2 border-[#B7CBDA] bg-white lg:px-4 py-8 rounded-[2.5rem] 3xxl:px-8 3xxl:py-12">
                <div className="grid grid-rows lg:grid-cols-6 gap-x-5">
                      ...
                      <div className="col-span-4">
                          <div className="flex flex-col">
                            <p className="flex-1 text-left tracking mt-6 text-base font-normal ssm:text-[1.4rem] md:mt-0 lg:text-[0.8rem] mxl:text-[0.8rem] mmxl:text-[1rem] xl:text-[20px] 3xxl:text-[1.5rem]">
                            ...
                            <div className="flex-none mt-3 3xxl:mt-[10%]">
                                <h5 className="text-left font-semibold ssm:text-3xl lg:text-lg mxl:text-lg xl:text-2xl 3xxl:text-3xl">
                                  Devi Puspitasari
                                </h5>
                                <hr className="my-3 w-2/6 lg:w-[15%] border border-orange-200 lg:my-1 mxl:my-1 xl:my-3" />
                                <h5 className="text-left text-md lg:text-sm xl:text-md font-light mxl:text-sm 3xxl:text-xl">
                                  Kurikulum Analis
                                </h5>
                              </div>
                          </div>
                ...
                <div className="grid grid-rows lg:grid-cols-6 gap-x-5">
                      ...
                      <div className="col-span-4">
                          <div className="flex flex-col">
                            ...
                            <div className="mt-3 flex-none 3xxl:mt-[10%]">
                            <h5 className="text-left font-semibold ssm:text-3xl lg:text-lg mxl:text-lg xl:text-2xl 3xxl:text-3xl">
                                Ghina Nuha Mufida
                                </h5>
                                <hr className="my-3 w-2/6 lg:w-[15%] border border-orange-200 lg:my-1 mxl:my-1 xl:my-3" />
