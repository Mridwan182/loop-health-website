...
const StartNow = () => {
  ...
  return (
    <div>
      <div className="mx-auto flex flex-col px-0  pt-12 md:px-0 lg:flex-row lg:px-10 mxl:px-12 mmxl:px-24">
        {/* Left Column */}
        <div className="mb-3 flex flex-col px-8 md:mb-12 md:px-24 lg:px-0 lg:mb-0 lg:w-2/3 lg:grow lg:items-start lg:text-left mxl:px-0 ">
          <h2
        ...
        sm:text-sm ssm:text-[1.5rem] md:mr-12 md:text-[1.4rem] lg:mr-12 lg:text-xl mxl:mr-[calc(100%_-_21rem)] mxl:text-[1rem] mxl:leading-6 mmxl:mr-[1rem]
        xl:mr-[0rem]
        xl:text-[1.4rem]
        xl:leading-8
        3xl:pr-[10rem]
        ...
        "
          ...
          <div className="mx-auto mt-10 -mb-[8rem] inline-block items-center justify-center space-x-0 sm:space-x-3 ssm:-mb-[10rem] lg:mb-0 md:space-x-2 lg:mx-0 lg:flex lg:space-x-8 mxl:mb-0 ">
            <button
              className="
          mb-4 
          inline-flex 
        ...
        <img
          ...
          className="
          hidden
          md:hidden lg:absolute lg:right-0 lg:bottom-[calc(100%_-_150em)] lg:block 
          lg:h-[60rem] mxl:absolute mxl:right-0 mxl:bottom-[calc(100%_-_140em)] mxl:block 
        ...
        <img
          ...
          hidden
          md:hidden
          lg:absolute lg:right-0 lg:bottom-[calc(100%_-_146em)] lg:block lg:h-[43rem] 
          mxl:absolute mxl:right-0 mxl:bottom-[calc(100%_-_136em)] mxl:block mxl:h-[34rem] 
