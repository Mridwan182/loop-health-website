...
const Service = () => {
  return (
    <div>
      <div
        className="mx-auto flex flex-col px-8 py-12 sm:px-8 md:px-16 lg:flex-col lg:px-24 lg:pb-20 mxl:flex-col mxl:px-12 mmxl:flex-row mmxl:px-24 xl:mt-[6rem] xl:flex-row 
    2xl:mt-[20%]
    3xl:mt-[8%]
    4xl:mt-[28%]"
      >
        ...
        "
          >
            ...
            <br className="hidden xl:block" /> Bagi{' '}
            <span className="font-bold text-darkblue-100">
